...
class AppDecoration {
  static var txtOutlineBlueGray100;
  ...
  static BoxDecoration get outlineTeal900 => BoxDecoration(
        color: ColorConstant.whiteA700,
        border: Border.all(
  ...
  static BoxDecoration get outlineGray60005 => BoxDecoration(
        color: ColorConstant.whiteA700,
        boxShadow: [
          BoxShadow(
  ...
  static BoxDecoration get outlineGray6000a1 => BoxDecoration(
        color: ColorConstant.whiteA700,
        boxShadow: [
          BoxShadow(
  ...
  static BoxDecoration get outlineGray1012 => BoxDecoration(
        color: ColorConstant.whiteA700,
        border: Border.all(
  ...
  static BoxDecoration get fillGray90026 => BoxDecoration(
        color: ColorConstant.gray90026,
      );
  static BoxDecoration get outlineGray6000a => BoxDecoration(
        color: ColorConstant.whiteA700,
        boxShadow: [
          BoxShadow(
            color: ColorConstant.gray6000a,
  ...
  static BoxDecoration get outlineDeeporange400261 => BoxDecoration(
        color: ColorConstant.primary,
        boxShadow: [
          BoxShadow(
            color: ColorConstant.deepOrange40026,
            spreadRadius: getHorizontalSize(
              2.00,
            ),
            blurRadius: getHorizontalSize(
  ...
  static BoxDecoration get gradientWhiteA70000WhiteA7001 => BoxDecoration(
  ...
  static BoxDecoration get gradientGray900b2Gray90000 => BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment(
            -4.736111107669293,
            0.5000000005211821,
  ...
  static BoxDecoration get outlineWhiteA7001 => BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: ColorConstant.deepOrange4001e,
            spreadRadius: getHorizontalSize(
              2.00,
            ),
            blurRadius: getHorizontalSize(
  ...
  static BoxDecoration get fillGray902 => BoxDecoration(
        color: ColorConstant.gray902,
      );
  static BoxDecoration get fillGray50 => BoxDecoration(
        color: ColorConstant.gray50,
      );
  static BoxDecoration get txtOutlineGray60005 => BoxDecoration(
        color: ColorConstant.whiteA700,
        boxShadow: [
          BoxShadow(
            color: ColorConstant.gray60005,
  ...
  static BoxDecoration get outlineDeeporange40026 => BoxDecoration(
        // color: ColorConstant.primary,
        boxShadow: [
          BoxShadow(
            color: ColorConstant.gray60019,
  ...
  static BoxDecoration get outlineGray101 => BoxDecoration(
        color: ColorConstant.whiteA700,
        border: Border.all(
          color: ColorConstant.gray101,
          width: getHorizontalSize(
  ...
  static BoxDecoration get outlineDeeporange40019 => BoxDecoration(
  ...
  static BoxDecoration get outlineGray1011 => BoxDecoration(
        border: Border.all(
          color: ColorConstant.gray101,
          width: getHorizontalSize(
            1.00,
  ...
  static BoxDecoration get fillGray9001e => BoxDecoration(
