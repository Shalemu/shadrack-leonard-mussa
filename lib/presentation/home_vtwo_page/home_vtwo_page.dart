...
import 'package:mauzoApp/presentation/Components/Pos.dart';
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            // Row 1: Expenses, Customers, Suppliers
                            Row(
                                ...
                                Column(
                                  children: [
                                    FloatingActionButton(
                                      ...
                                      // To reduce the FAB size
                                    ),
                                    SizedBox(
                                        height:
                                            4), // Space between FAB and label
                                    Text('Expenses'),
                                  ],
                                ),
                                // Customers FAB
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    FloatingActionButton(
                                      onPressed: () {
                                        ...
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  HomeVtwoPage1(
                                                itemName: _usernameController
                                                    .text, // Pass necessary data
                                                token:
                                                    token, // Pass the token if required
                                                deviceKey: '',
                                              ),
                                            ));
                                      },
                                      ...
                                      backgroundColor:
                                          Colors.orange, // Orange color for POS
                                      tooltip: 'POS',
                                ...
                                Column(
                                  children: [
                                    FloatingActionButton(
                                      ...
                                      backgroundColor: Colors.orange[
                                          300], // Red color for Expenses
                                      tooltip: 'Sale',
                                      child: Icon(Icons.local_offer),
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(
                                            10), // Reduced radius
                                      ), // Different icon for Expenses
                                      // Reduce FAB size
                                    ),
                                    SizedBox(height: 4),
                                    Text('Sale'),
                                ...
                                Column(
                                  children: [
                                    FloatingActionButton(
                                      onPressed: () {
                                        // Handle Receipts Action
                                        print('Receipts tapped');
                                      },
                                      backgroundColor: Colors.green[
                                          50], // Purple color for Receipts
                                      tooltip: 'Receipts',
